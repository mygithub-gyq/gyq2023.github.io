...
text(0.03, 116, ['CD=' num2str(cd)], 'FontSize', 12, 'HorizontalAlignment', 'left', 'Color', 'r');
...
% % 改为升序标注
% for i = 1:k
%     text((i-1)/(k-1), 105, num2str(i), 'FontSize', 12, 'HorizontalAlignment', 'center');
% end
% 
% % compute average ranks
% r       = mean(r);
