...
df = pd.read_excel(r'C:\Users\20583\Desktop\data\data\result.xlsx', header=None)

# 对每一行应用函数
df['WTL_Result'] = df.apply(lambda row: get_wtl(row.tolist()), axis=1)

# 将结果写回Excel文件
df.to_excel(r'C:\Users\20583\Desktop\data\data\result6.xlsx', index=False)

import pandas as pd

# 读取 Excel 文件，假设两个文件分别是 file1.xlsx 和 file2.xlsx
df1 = pd.read_excel(r'C:\Users\20583\Desktop\data\data\result.xlsx', header=None)  # 第一个表格
df2 = pd.read_excel(r'C:\Users\20583\Desktop\data\data\num.xlsx', header=None)  # 第二个表格
...
# 将结果保存到新的 Excel 文件
result_df.to_excel(r'C:\Users\20583\Desktop\data\data\merged_result13.xlsx', index=False, header=False)
